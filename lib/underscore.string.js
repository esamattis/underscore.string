...
(function(root){
  ...
  var _s = {
    ...
    include: function(obj, needle) {
      if (/string|number/.test(typeof obj)) {
        return this.includes(String(obj), needle);
      } else {
        if (_include) { return _include(obj, needle) }
      }
    },
    ...
    reverse: function(obj){
      if (/string|number/.test(typeof obj)) {
        ...
        if (_reverse) { return _reverse.call(_(obj)); }
      }
    },
  ...
  _([
    ...
    'lines', 'splice', 'startsWith', 'endsWith', 'succ', 'titleize',

...
!function(root, String){
  ...
  var _s = {
    ...
    endsWith: function(str, ends, position){
      ...
      var lastIndex = str.indexOf(ends, position);
    ...
    slugify: function(str) {
      var from  = "ąàáäâãåæăćčĉęèéëêĝĥìíïîĵłľńňòóöôõðøśșšŝťțŭùúüûñÿýçżźž",
          to    = "aaaaaaaaaccceeeeeghiiiijllnnooooooossssttuuuuunyyczzz",

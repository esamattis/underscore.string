...
!function(root){
  ...
  var levenshtein = function(str1, str2) {
    ...
    return Math.min(
      levenshtein(str1.substring(1), str2.substring(1)) + ~~(str1.charAt(0) !== str2.charAt(0)),
      levenshtein(str1.substring(1), str2) + 1,
      levenshtein(str1, str2.substring(1)) + 1
    );
  }
  ...
  var _s = {
    ...
    levenshtein: function (s1, s2) {
      // Source: https://gist.github.com/979790
      // original by: Carlos R. L. Rodrigues (http://www.jsfromhell.com)
      // Modified for underscore.string by Achilleas Buisman (http://abuisman.nl, http://github.com/abuisman)
